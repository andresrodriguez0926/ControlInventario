...
// Since the dashboard visualizes despachadasProductor and Cliente independently, zero-out negatives for the global dashboard numbers just in case, but keep internal debts!
...
fs.writeFileSync('reconstructed_perfect_v8.json', JSON.stringify(state, null, 2));
